...
- 2026-09-24 : Top 5 des coworkings a Paris (`/blog/meilleurs-coworking-paris/` + `/en/blog/top-coworking-spaces-paris/`) | manuel, GEO classement 5 operateurs (Morning 1er, Deskopolitan 2e, Wojo 3e, Hiptown 4e, WeWork 5e). QFO meilleurs espaces coworking Paris 2026 / top coworking spaces Paris 2026. Angle generaliste pour differencier de coworking-freelance-paris et quel-meilleur-operateur-location-bureau-paris. Donnees 2026-09-24 : Deskopolitan Voltaire 6 000 m2 (Pasteur non ouvert au public), 7 EUR HT/h, 42 EUR HT/jour, resident 590 EUR HT/mois, bureau prive 700 EUR HT/poste des 4 pers. Anticafe n'a plus de lieu a Paris (Bordeaux, Strasbourg seulement), Kwerk = bureaux operes 3 adresses Paris 8 sans offre coworking : tous deux ecartes. Citation Ubiqdata 2025 (300 EUR open space / 600 EUR privatif)
...
- 2026-09-22 — Centre d'affaires : definition, services et prix (`/blog/centre-d-affaires/` + `/en/blog/business-centre-guide/`) | auto. Mode d'analyse : crazyserp (Datafer a repondu 401, cle invalide). AIO non declenchee sur la requete. Volume CrazySERP 1900/mois en moyenne sur 12 mois, CPC 5 a 20 EUR. SERP mixte : 4 guides definitionnels (LegalPlace, SeDomicilier, Kandbaz, Le Lodge) et 4 annuaires ou operateurs. Angle retenu : la nature juridique du contrat (prestation de services et non bail commercial), absente des 4 guides concurrents, plus un tableau centre d'affaires / coworking / bail 3-6-9. Tarifs alignes sur ceux deja publies par le blog (prix-coworking-paris et domiciliation-entreprise-paris) pour eviter toute contradiction interne. 1588 mots FR, 1479 mots EN
...
- Semaine du 2026-09-21 au 2026-09-27 : **5 articles publies, quota de 4 depasse de 1**. Le compteur etait reste a 2 alors que 4 articles etaient deja en ligne (avantages et inconvenients du coworking, GEO comparatif quartier Bourse, coworking freelance, sous-location). Le 5e est l'article evergreen auto centre d'affaires, dont la `scheduled_date` avait ete avancee a la main au 2026-09-22 pour le run de test. A arbitrer par Manon : decaler le prochain creneau de la roadmap (bureau assis debout, 2026-09-25) a la semaine suivante pour revenir sous la limite
...
- **Le domaine `conseil.morning.fr` est en ligne en HTTPS** (verifie le 2026-09-22 : les pages, le sitemap, les images et le `llms.txt` repondent 200, et l'URL de demo `analytics-ds.github.io/morning-conseil/` redirige en 301 vers lui). La section « Reste a faire » du `CLAUDE.md` du blog dit encore le contraire, elle est perimee sur ce point. Consequence pratique : les verifications post-publication peuvent se faire directement sur `conseil.morning.fr`, et le build sur la baseURL de demo ne sert plus qu'a controler la non-regression des liens en sous-repertoire.
- **`https://www.morning.fr/bureaux-coworking` renvoie une 404** (constate le 2026-09-22). La page vivante pour les photos d'espaces est `https://www.morning.fr/bureaux`. La table des pages sources de l'etape 5 de `create-article-auto` et la section « Images des articles » du `CLAUDE.md` pointent encore vers l'ancienne URL.
- **L'image Open Graph perd le sous-repertoire sur la baseURL de demo** : `seo-head.html` emet `https://analytics-ds.github.io/images/blog/x.webp` au lieu de `https://analytics-ds.github.io/morning-conseil/images/blog/x.webp`. Bug pre-existant sur tous les articles, sans effet sur `conseil.morning.fr` qui sert a la racine. A corriger en passant par le partial `asset.html` si l'URL de demo doit rester partageable.
