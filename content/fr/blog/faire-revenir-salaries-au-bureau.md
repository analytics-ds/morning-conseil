---
title: "Faire revenir les salariés au bureau : pourquoi et comment"
...
toc: true
enBref:
  - "Le sujet est moins brûlant qu'il n'y paraît : **94 % des entreprises** interrogées par l'Apec en mars 2026 ne prévoient aucun changement de leur politique de télétravail cette année."
  - "Les motifs invoqués par celles qui font revenir leurs équipes sont d'abord relationnels : **38 % citent le recrutement**, 33 % l'engagement, 23 % la limitation des départs."
  - "La contrainte seule échoue : les entreprises qui ont durci leur politique sans rien changer aux conditions de travail affichent des taux de mécontentement de **74 à 80 %**."
  - "Le levier le plus efficace est le **jour d'ancrage collectif** par équipe, pas le quota individuel de jours de présence."
  - "Un bureau où l'on ne peut pas se concentrer ne fait revenir personne : **71 % des personnes en environnement ouvert** déclarent que le bruit gêne leur concentration."
faq:
  - q: "Combien de jours de présence au bureau faut-il imposer ?"
    a: "La question du nombre est secondaire par rapport à celle de la synchronisation. Deux jours choisis librement par chacun produisent des bureaux occupés à moitié en permanence et des équipes qui ne se croisent jamais. Deux jours communs à une même équipe produisent des journées denses et des journées calmes, ce qui est exactement l'effet recherché. Le rythme moyen observé aujourd'hui tourne autour de 1,9 jour de télétravail par semaine, donc trois jours de présence."
  - q: "Peut-on obliger un salarié à revenir au bureau ?"
    a: "Cela dépend de ce qui a été formalisé. Le télétravail relève en général d'un accord collectif ou d'une charte, révisables selon leurs propres modalités, mais s'il figure dans le contrat de travail, sa suppression constitue une modification du contrat qui requiert l'accord du salarié. Dans tous les cas, l'enjeu pratique n'est pas juridique mais social : une politique imposée sans contrepartie se traduit par des départs, ce que 23 % des entreprises concernées cherchent précisément à éviter."
  - q: "Les services et les avantages suffisent-ils à faire revenir les équipes ?"
    a: "Non, et c'est l'erreur la plus fréquente. Une conciergerie, un food truck ou une salle de sport améliorent une journée déjà décidée, ils ne la déclenchent pas. Ce qui déclenche le déplacement, c'est la certitude de retrouver des collègues précis un jour précis, et la possibilité de travailler correctement une fois sur place. Les services viennent après ces deux conditions, jamais à leur place."
  - q: "Comment savoir si notre bureau est sous-dimensionné ou surdimensionné ?"
    a: "En mesurant l'occupation réelle sur plusieurs semaines complètes, jour par jour, plutôt qu'en raisonnant sur l'effectif. Le bon indicateur est le taux d'occupation du mardi, du mercredi ou du jeudi, pas la moyenne hebdomadaire qui écrase les pics. Un plateau saturé trois jours sur cinq et vide les deux autres n'est pas surdimensionné, il est mal calibré sur les pics."
  - q: "Par quoi commencer si le budget est limité ?"
    a: "Par les jours d'ancrage, qui ne coûtent rien et produisent l'effet le plus visible. Puis par le traitement acoustique et l'ajout d'espaces fermés, qui ne demandent pas de refonte complète du plan. L'aménagement lourd, le déménagement et les services viennent ensuite, une fois que les usages sont stabilisés et mesurés."
draft: false
---
...
{{< bon-a-savoir >}}
Avant de fixer une règle, vérifiez ce qui manque réellement. Si le problème est la transmission vers les nouveaux arrivants, un jour commun par équipe suffit. Si le problème est le décloisonnement entre services, c'est un jour commun à l'échelle du site qu'il faut viser. Les deux ne se traitent pas avec le même dispositif.
{{< /bon-a-savoir >}}
...
Dans l'ordre : fixer les jours d'ancrage par équipe, ce qui ne coûte rien et produit l'effet le plus immédiat ; mesurer l'occupation réelle pendant un mois ; corriger l'acoustique et le nombre d'espaces fermés ; enfin seulement, arbitrer sur la surface et la localisation. Si le trajet ressort comme motif principal, la question devient immobilière et se traite à l'échéance du bail : le [choix du quartier d'implantation](/blog/ou-installer-ses-bureaux-paris/) pèse davantage sur la fréquentation que n'importe quel dispositif interne.

Pour situer un budget avant d'engager une réflexion sur un changement de site, les [prix du coworking à Paris](/blog/prix-coworking-paris/) donnent un ordre de grandeur au poste, et les offres de [location de bureaux](https://www.morning.fr/bureaux/location-bureaux) permettent de comparer des surfaces réelles sur des localisations bien desservies.
