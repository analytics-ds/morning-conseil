---
title: "Flex office : mode d'emploi et pièges à éviter"
...
imageAlt: "Plateau de bureaux Morning occupé en flex office"
author: "helene-morvan"
toc: true
enBref:
  - "Le flex office consiste à supprimer l'attribution nominative des postes, pas à réduire brutalement leur nombre."
  - "Un ratio de **0,7 poste par personne** convient à la plupart des équipes en trois jours de présentiel."
  - "L'échec vient presque toujours du sous-dimensionnement des espaces annexes, pas du nombre de postes."
  - "Sans règle de réservation claire et sans casiers, le modèle se dégrade en quelques semaines."
faq:
  - q: "Qu'est-ce que le flex office exactement ?"
    a: "C'est une organisation dans laquelle les postes de travail ne sont plus attribués nominativement : chaque personne s'installe à un poste libre à son arrivée et le libère en partant. Le nombre de postes est calibré sur la présence réelle observée, non sur l'effectif total."
  - q: "Quel ratio de postes par personne faut-il prévoir ?"
    a: "Pour une équipe présente trois jours par semaine en moyenne, un ratio de 0,7 poste par personne constitue une base solide. Descendre à 0,6 est possible avec un pilotage fin des présences. En dessous, la tension devient perceptible dès le premier pic d'affluence."
  - q: "Le flex office fait-il vraiment économiser ?"
    a: "Oui sur la surface, mais l'économie est partiellement réinvestie dans les espaces annexes : phone boothes, salles de réunion supplémentaires, casiers, zones de concentration. Le gain net se situe généralement entre 15 et 25 % du coût immobilier."
  - q: "Comment gérer les jours de forte affluence ?"
    a: "En instaurant une visibilité des présences, calendrier partagé ou outil de réservation, et en fixant des jours d'équipe différenciés pour lisser l'affluence. Sans lissage, le mardi et le jeudi saturent tandis que le vendredi reste vide."
  - q: "Le flex office est-il compatible avec toutes les équipes ?"
    a: "Non. Les postes qui nécessitent un équipement fixe spécifique, un double écran calibré, du matériel technique ou un accès à des documents physiques confidentiels, doivent rester attribués. Le flex office s'applique à la majorité des postes, pas à tous."
draft: false
---
...
{{< bon-a-savoir >}}
Mesurez les présences avant l'annonce du projet, pas après. Une fois le flex office annoncé, les comportements changent immédiatement et les données deviennent inexploitables pour le dimensionnement.
{{< /bon-a-savoir >}}
...
1. **La règle du bureau propre.** Un poste libéré est un poste vide, sans exception. Sans cette règle, l'attribution informelle réapparaît en quelques jours.
2. **La visibilité des présences.** Un calendrier partagé ou un outil de réservation permet à chacun de savoir qui sera là. C'est ce qui évite de venir au bureau pour travailler seul.
3. **Les jours d'équipe.** Fixer un jour de présence collective par équipe donne du sens au déplacement et lisse l'affluence si les jours sont répartis entre équipes.
4. **Les exceptions assumées.** Certains postes restent attribués, pour raison d'équipement ou de contrainte physique. Ces exceptions doivent être explicites et justifiées, sinon elles deviennent un sujet d'équité.
...
Concrètement, un espace flexible bien équipé en cabines et petites salles vaut mieux qu'un plateau plus grand et nu. Cette logique modifie aussi l'arbitrage entre formules d'occupation : le sujet est traité dans notre comparatif entre [bureau privé et open space](/blog/bureau-prive-ou-open-space/).

Sur le plan budgétaire, la réduction de surface permet souvent de conserver une adresse centrale à coût constant, ce qui déplace le débat sur l'implantation. Les écarts entre quartiers sont détaillés dans notre article sur les [quartiers où installer ses bureaux à Paris](/blog/ou-installer-ses-bureaux-paris/), et les fourchettes de tarifs dans celui consacré aux [prix du coworking à Paris](/blog/prix-coworking-paris/).
