---
title: "Bureaux du futur : les tendances qui se dessinent deja"
...
toc: true
enBref:
  - "La surface se contracte avant tout le reste : le passage au flex office rend en général **20 à 40 % des mètres carrés** occupés, et la demande placée en Île-de-France reste **18 % sous sa moyenne des cinq dernières années**."
  - "Le télétravail s'est stabilisé autour de **1,9 jour par semaine** contre 2,7 en 2021 : c'est désormais une donnée de dimensionnement, plus une variable en mouvement."
  - "Le **décret tertiaire** impose -40 % de consommation en 2030, -50 % en 2040 et -60 % en 2050 à tout bâtiment de plus de 1 000 m². Ces échéances sont datées, contrairement aux tendances d'ambiance."
  - "Le confort devient un critère de conception : **71 % des personnes en environnement ouvert** déclarent que le bruit gêne leur concentration."
  - "Le bureau se loue de plus en plus comme un service, avec des engagements courts et un prix au poste tout compris."
faq:
  - q: "À quoi ressembleront les bureaux en 2030 ?"
    a: "Plus petits en surface totale, mais plus variés en types d'espaces. La baisse du nombre de postes assis individuels se poursuit, compensée par davantage de salles fermées, de bulles d'appel et d'espaces informels. Le deuxième changement est réglementaire : les bâtiments de plus de 1 000 m² devront afficher 40 % de consommation énergétique en moins qu'à leur année de référence. Cette échéance, elle, est datée et opposable."
  - q: "Le télétravail va-t-il continuer à réduire la surface de bureaux ?"
    a: "La contraction est déjà largement passée. Le rythme moyen s'est stabilisé autour de 1,9 jour de télétravail par semaine, contre 2,7 en 2021, et les politiques d'entreprise bougent peu d'une année sur l'autre. L'effet sur les surfaces vient maintenant du renouvellement des baux plutôt que d'une nouvelle vague de réduction : chaque échéance de bail est l'occasion d'ajuster une surface dimensionnée avant 2020."
  - q: "Faut-il anticiper le décret tertiaire dès maintenant ?"
    a: "Oui si vous occupez ou envisagez un bâtiment de plus de 1 000 m² à usage tertiaire. Les obligations portent sur le bâtiment, mais leur coût se répercute sur les charges et les travaux pendant la durée du bail. Vérifier l'année de référence déclarée et la trajectoire prévue par le propriétaire fait partie des questions à poser avant de signer, au même titre que le prix au mètre carré."
  - q: "Le bureau du futur sera-t-il toujours au centre-ville ?"
    a: "Les chiffres du marché francilien montrent une polarisation forte : la vacance reste autour de 8 % dans Paris intra-muros et dépasse 20 % dans certains secteurs de première couronne. La centralité et la desserte restent donc les critères les plus discriminants, et rien n'indique que cela change d'ici 2030. Ce qui évolue, c'est la surface prise au centre, pas la localisation."
  - q: "Comment dimensionner ses bureaux quand tout bouge encore ?"
    a: "En partant de l'occupation réelle mesurée sur plusieurs semaines, pas du nombre de contrats de travail. Un ratio de 0,7 poste par personne convient à la plupart des organisations en travail hybride, à condition de prévoir en parallèle assez de salles et d'espaces fermés. Les contrats courts sont l'autre réponse : ils permettent de réajuster à douze ou vingt-quatre mois plutôt que de s'engager à neuf ans sur une hypothèse."
draft: false
---
...
Cette contraction ne signifie pas que les entreprises se passent de bureaux. Elle signifie qu'elles en prennent moins, et qu'elles les remplissent autrement. Le nombre de postes assis individuels baisse, tandis que la part des surfaces collectives augmente : salles fermées, bulles d'appel, espaces de travail informels. Le [flex office](/blog/flex-office-mode-emploi/) n'est plus une expérimentation à tester mais le point de départ du plan d'aménagement, avec un ratio courant de 0,7 poste par personne.

{{< bon-a-savoir >}}
Une réduction de surface ne se calcule pas sur l'effectif, mais sur le taux d'occupation observé sur plusieurs semaines complètes, jours creux inclus. Une mesure faite sur un mardi donne systématiquement un dimensionnement trop large, un vendredi un dimensionnement trop serré.
{{< /bon-a-savoir >}}
...
Le sujet est amplifié par la généralisation des réunions mixtes, mi-présentielles mi-distancielles. Un défaut acoustique qui passait inaperçu dans une réunion entièrement en salle devient audible dès la première visioconférence. C'est ce qui explique que l'[aménagement des salles de réunion](/blog/amenager-salle-de-reunion/) intègre désormais un traitement acoustique chiffré dès l'avant-projet, et que l'arbitrage entre [bureau privé et open space](/blog/bureau-prive-ou-open-space/) se fasse davantage sur des critères de concentration que sur des critères de statut.
