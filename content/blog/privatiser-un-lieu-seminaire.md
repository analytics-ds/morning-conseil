---
title: "Privatiser un lieu pour un séminaire à Paris"
...
imageAlt: "Groupe réuni lors d'un événement dans un lieu Morning"
author: "helene-morvan"
toc: true
enBref:
  - "La capacité annoncée par un lieu correspond rarement à la capacité utilisable : la **configuration assise** divise souvent le chiffre par deux."
  - "Trois postes font déraper les budgets : la restauration, la technique son et lumière, et les heures supplémentaires."
  - "La question de l'exclusivité du traiteur doit être posée avant toute négociation de prix."
  - "Une visite technique, distincte de la visite commerciale, évite l'essentiel des mauvaises surprises."
faq:
  - q: "Combien coûte la privatisation d'un lieu pour un séminaire à Paris ?"
    a: "Le tarif de mise à disposition dépend de la surface, du créneau et de la saison, mais il ne représente souvent que 30 à 40 % du budget final. La restauration, la technique et le personnel constituent le reste. Un budget global par participant est un indicateur plus fiable que le seul prix du lieu."
  - q: "Combien de personnes peut réellement accueillir un lieu ?"
    a: "La capacité varie fortement selon la configuration. Un même espace peut accueillir cent personnes en cocktail debout, soixante en configuration théâtre et quarante en format assis avec tables. Toujours demander la capacité dans la configuration précise envisagée, pas la capacité maximale."
  - q: "Faut-il prendre un lieu avec traiteur imposé ?"
    a: "Un traiteur exclusif simplifie la logistique et engage le lieu sur la qualité, mais réduit la marge de négociation et la souplesse sur les régimes alimentaires. Un lieu ouvert à un traiteur externe demande davantage de coordination mais permet un meilleur rapport qualité-prix sur les gros volumes."
  - q: "Quels équipements techniques vérifier avant de signer ?"
    a: "La puissance électrique disponible, le nombre et l'emplacement des prises, la présence d'une sonorisation et son couplage à un micro HF, la qualité de la connexion internet et sa capacité en nombre d'appareils simultanés, et enfin les possibilités d'occultation de la lumière du jour."
  - q: "Quel délai de réservation prévoir ?"
    a: "Pour un séminaire parisien de septembre, novembre ou juin, périodes les plus tendues, prévoir trois à six mois. Pour un créneau creux, en juillet, août ou en milieu de semaine hivernale, six à huit semaines suffisent souvent et la négociation est plus favorable."
draft: false
---
...
1. **Le déroulé horaire** heure par heure, y compris les temps de montage et de démontage.
2. **La configuration dominante** : assis avec tables, théâtre, cocktail debout, ou alternance des trois.
3. **Le besoin de sous-espaces** pour des ateliers en parallèle.
4. **Le format de restauration** : pause, déjeuner assis, buffet, cocktail dînatoire.
...
{{< bon-a-savoir >}}
Demandez systématiquement un plan côté du lieu avec l'implantation prévue pour votre configuration. Un lieu sérieux le fournit sans difficulté. Un refus ou un plan approximatif est en soi une information.
{{< /bon-a-savoir >}}
...
**L'acoustique.** Un volume réverbérant rend une prise de parole inintelligible même bien sonorisée. Les principes de diagnostic sont les mêmes que ceux décrits dans notre guide sur l'[aménagement d'une salle de réunion](/blog/amenager-salle-de-reunion/).
...
Enfin, le choix du quartier compte autant pour un événement que pour des bureaux : accessibilité en transports, capacité de stationnement, offre de restauration à proximité pour les temps informels. Les critères sont proches de ceux exposés dans notre comparatif des [quartiers où installer ses bureaux à Paris](/blog/ou-installer-ses-bureaux-paris/).
