---
title: "Aménager une salle de réunion : acoustique, lumière, mobilier"
...
imageAlt: "Salle de réunion équipée dans un espace Morning"
author: "antoine-riviere"
toc: true
enBref:
  - "Compter **2 m² par personne** au minimum, hors circulation, pour une salle de réunion assise."
  - "L'acoustique est le premier facteur de confort, très loin devant le mobilier."
  - "Une salle de visio se conçoit autour de la caméra et du micro, pas autour de la table."
  - "Les petites salles de deux à quatre places sont systématiquement sous-dimensionnées dans les projets."
faq:
  - q: "Quelle surface prévoir pour une salle de réunion ?"
    a: "Comptez environ 2 m² par personne assise, hors circulation et hors mobilier annexe. Une salle de six personnes demande donc une douzaine de mètres carrés utiles, portés à quinze avec les dégagements. En dessous, l'inconfort apparaît dès que la réunion dépasse une heure."
  - q: "Comment améliorer l'acoustique d'une salle existante ?"
    a: "Trois interventions donnent des résultats immédiats : poser des panneaux absorbants sur les murs opposés, ajouter un tapis épais au sol et installer des rideaux lourds si la salle comporte de grandes surfaces vitrées. Le traitement du plafond vient ensuite, avec des dalles acoustiques."
  - q: "Quel éclairage choisir pour une salle de réunion ?"
    a: "Un éclairage indirect et homogène, autour de 400 à 500 lux au niveau de la table, avec une température de couleur neutre proche de 4000 K. Éviter les spots ponctuels au-dessus des visages, qui créent des ombres marquées en visioconférence."
  - q: "Faut-il une table rectangulaire ou ovale ?"
    a: "Ovale ou ronde pour les réunions de travail à moins de huit personnes, car chacun voit tout le monde. Rectangulaire pour les configurations de présentation, où l'attention se porte vers un écran. La forme compte moins que la distance à l'écran et à la caméra."
  - q: "Combien de salles de réunion prévoir pour une équipe ?"
    a: "Une base courante consiste à prévoir une place de salle de réunion pour trois à quatre personnes présentes, en privilégiant les petits formats. Dans une organisation en flex office, ce ratio doit être augmenté car les échanges informels migrent du poste vers les salles."
draft: false
---
...
Le second paramètre est le nombre de salles, et sa répartition par taille. La plupart des projets prévoient une grande salle et une moyenne, alors que l'usage réel se concentre sur les formats de deux à quatre personnes. Dans une organisation en [flex office](/blog/flex-office-mode-emploi/), ce déséquilibre devient critique : les conversations qui se tenaient au poste migrent vers les salles, et les petits formats saturent.
...
{{< bon-a-savoir >}}
Test rapide pour évaluer une salle avant de la retenir : entrer seul, taper une fois dans les mains fort et écouter la traînée sonore. Si le son persiste plus d'une demi-seconde, la salle réverbère trop et nécessitera un traitement absorbant.
{{< /bon-a-savoir >}}
...
Cette logique vaut également pour les espaces destinés à recevoir du public ou à accueillir un événement, où les contraintes de flux, de sonorisation et de restauration prennent le pas sur le confort d'écoute. Ce sujet est traité dans notre guide sur la [privatisation d'un lieu pour un séminaire](/blog/privatiser-un-lieu-seminaire/).

Enfin, la disponibilité de salles bien conçues fait partie des critères de sélection d'un espace de travail, au même titre que le tarif au poste. Les points de vigilance sur ce périmètre sont détaillés dans notre comparatif entre [bureau privé et open space](/blog/bureau-prive-ou-open-space/).
