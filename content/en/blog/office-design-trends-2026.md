...
toc: true
enBref:
  - "Hybrid work is no longer a hypothesis to test, it directly shapes desk ratios and the number of meeting rooms."
  - "Partial assigned desking is coming back against full open space, on concentration criteria rather than status."
  - "Energy sobriety becomes a measurable purchasing criterion, not a marketing line on a brochure."
  - "Embedded technology (occupancy sensors, room booking) moves past gadget status to become a real square-meter management tool."
faq:
  - q: "What's the real office trend of 2026?"
    a: "It's not an object or a material, it's a ratio: the number of assigned desks relative to headcount is structurally falling, in favor of shared surfaces (meeting rooms, phone boxes, informal spaces). 2026 office design starts with square-meter allocation, before furniture choices."
  - q: "Should companies go back to assigned desks in 2026?"
    a: "Not everywhere, but the arbitration is getting more precise. Teams with high individual concentration needs (legal, finance, development) often get an assigned or semi-assigned desk back, while sales and project teams stay on flex. The criterion is no longer hierarchical, it's functional."
  - q: "Does energy sobriety cost more in office design?"
    a: "Upfront, sensor-driven lighting or reinforced insulation cost more than a basic solution. The math is done over the lease term: savings on charges and compliance with future thermal regulations generally offset the gap over 3 to 5 years."
  - q: "Are occupancy sensors useful for a small structure?"
    a: "Below around thirty desks, the investment rarely pays off. Manual occupancy tracking (room calendars, team feedback) is enough. Sensors become worthwhile once several floors or several sites need to be arbitrated at the same time."
  - q: "How should trends be prioritized on a limited budget?"
    a: "Start with acoustics and lighting, which condition daily use and don't require reworking the floor plan. Then adjust the flex/assigned ratio based on team feedback. Embedded technology and environmental certifications come last, once the usage baseline is stable."
draft: false
---
...
[Flex office](/blog/flex-office-mode-emploi/) was long presented as one flexibility option among others. In 2026, it has become the starting point of the design project rather than a variant applied afterward. Interior design firms now factor in real occupancy rates, measured or estimated, before even drawing the layout.
...
{{< bon-a-savoir >}}
A simple indicator to check whether a flex floor is properly sized: count the number of personal lockers available. If it's lower than the number of employees attached to the site, the shift to flex hasn't been thought through to the end, only as far as the desk itself.
{{< /bon-a-savoir >}}
...
This isn't a new trend in itself, but a long-overdue catch-up: acoustics and lighting move out of the "finishes" box to become budget lines identified as early as the design phase. [Meeting room design](/blog/amenager-salle-de-reunion/) projects now include a costed acoustic treatment from the early project stage, rather than a fix applied after the first user complaints.
